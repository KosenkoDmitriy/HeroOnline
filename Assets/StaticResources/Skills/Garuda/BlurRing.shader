...
void vert (inout appdata_full v, out Input o) {
	...
	o.proj.zw = oPos.zw;
	o.color = v.color + float4(0,0,0.4f,0);
}
...
void surf (Input IN, inout SurfaceOutput o) {
		...
		o.Emission = (col.xyz * IN.color  + tex*_ColorStrength* IN.color * _TintColor.rgb) ;
        o.Alpha = _TintColor.a * IN.color.a * tex.a ;
}
ENDCG
}
