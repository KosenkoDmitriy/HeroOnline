...
public class EffectUpgradeItem : MonoBehaviour {
    ...
    public float resourceCount = 3;
    public UIItemUpgradeManager manager;

    public GameObject particleItemUpgrade;
    public GameObject particleItemUpgradeRoot;
    ...
    void Update()
    {
        switch (state)
        {
            ...
            case State.EndEffect:
                {
                    GameObject go = GameObject.Instantiate(particleItemUpgrade) as GameObject;
                    go.transform.parent = particleItemUpgradeRoot.transform;
                    go.transform.localScale = new Vector3(1, 1, 1);
                    go.transform.localPosition = new Vector3(0, 0, 0);
                    Destroy(go, 3);
                    Invoke("OnFinishedEffect", 0.5f);
